...
export function ColorsTable({ colors, loading, onEdit, onDelete, onRestore }: ColorsTableProps) {
    ...
    <div>
      <div className="p-6 border-b bg-gray-50">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-gray-900">{t("productColors")}</h2>
        </div>
                  ...
                  >
                    ...
                    <TableCell>
                      <ActionDropdown
                        ...
                        onRestore={onRestore ? () => onRestore(color.id.toString()) : undefined}
