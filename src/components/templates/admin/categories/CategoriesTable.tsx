...
export function CategoriesTable({ categories, loading, onEdit, onDelete, onRestore }: CategoriesTableProps) {
          ...
          <Table className="min-w-[800px]">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="min-w-[120px] hidden md:table-cell">Người tạo</TableHead>
                <TableHead className="min-w-[120px] hidden lg:table-cell">Ngày tạo</TableHead>
            ...
            <TableBody>
              <TableRow>
                <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-lg font-medium">{t("noCategoriesFound") || "Không tìm thấy danh mục nào"}</p>
                  <p className="text-sm">{t("noCategoriesDescription") || "Tạo danh mục đầu tiên để bắt đầu"}</p>
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
          ...
          <div key={category.id} className="bg-white border rounded-lg p-4 shadow-sm">
            <div className="flex items-start justify-between mb-3">
              ...
              <ActionDropdown
                ...
                onRestore={category.status === 'INACTIVE' && onRestore ? () => onRestore(parseInt(category.id)) : undefined}
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              >
                {t(category.status || 'INACTIVE') || category.status || 'INACTIVE'}
              </Badge>
