    ...
    return (
      <div className="p-4 text-center text-gray-500">
        ...
        <p className="text-xs mt-1">
          {t("noConversationsDescription") || "Cuộc trò chuyện sẽ xuất hiện khi khách hàng gửi tin nhắn"}
        </p>
        {onRefresh && (
      ...
      <ScrollArea className="flex-1">
        <div className="p-2">
          {conversations.map((conversation) => {
            ...
            const participantName = otherParticipant?.name || t("unknownCustomer") || "Khách hàng không rõ";
            ...
            return (
              <div
                ...
                onClick={() => isWebSocketConnected && onConversationSelect(conversation)}
              >
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-xs text-gray-500">
                      {conversation.type === 'DIRECT'
                        ...
                        : `${conversation.participants?.length || 0} ${t("members") || "thành viên"}`
                      }
                    </p>
