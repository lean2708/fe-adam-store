            ...
            <div className="relative h-[400px] bg-gradient-to-r from-gray-100 to-gray-200">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white max-w-2xl px-4">
                        ...
                        <Button onClick={()=>route.push('/news')} className="bg-[#FFFFFFB2] duration-400 outline-none border-1 border-[#EEEDED80] text-black rounded-3xl hover:bg-[#fffffff5] px-8 py-4 text-base font-medium cursor-pointer">
                            {t("heroBanner.buyNow")}
                        </Button>
                    </div>
                </div>
